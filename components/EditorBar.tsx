          ...
          <div className="hidden min-w-0 flex-1 items-center gap-1 md:flex lg:gap-1.5">
            <div className="flex min-w-0 flex-1 items-center gap-0.5 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              {TABS.map((tab) => (
                ...
                >
                  ...
                  <span className="mono hidden text-[0.78rem] text-bloodBright lg:inline">
                    .{tab.ext}
                  </span>
                </a>
              ))}
            ...
            <button
              ...
              className="
                ...
                text-text
                transition-colors
                hover:border-blood/60
                hover:text-bloodBright
                lg:px-3.5
                lg:text-[0.78rem]
              "
            >
                ...
                return (
                  <a
                    ...
                    className={`
                      ...
                      ${
                        isActive
                          ? "bg-blood/[0.13] text-bone"
                          : "text-textDim hover:bg-steel/[0.08] hover:text-text"
                      }
                    `}
                  >
                    {/* Active dot */}
